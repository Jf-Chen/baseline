...
def train(train_loader, model, criterion, optimizer, epoch_index, F_txt):
    ...
    for episode_index, (batch) in enumerate(train_loader(epoch_index)):
        ...
        # query_images [b,q_num,c,h,w] -> [b*q_num,c,h,w]
        # support_images [b,shot*way,c,h,w] -> [b*shot*way,c,h,w]

        # Calculate the output
        output, Q_S = model(input_var1, input_var2)# [b*q_num,c,h,w],[b*shot*way,c,h,w]
