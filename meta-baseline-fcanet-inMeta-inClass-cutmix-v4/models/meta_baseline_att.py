...
class MetaBaseline(nn.Module):
    ...
    def __init__(self, encoder, encoder_args={}, method='M2L_Wass',
                 temp=10., temp_learnable=True, num_classes=5, neighbor_k=3, batch_size=4, shot_num=1):
...
#========================== M2L Wass  ==========================#
##   input1_batch ,   input2_batch
##  [b*q_num,H*W,C] [b*shot*way,H*W,C]
