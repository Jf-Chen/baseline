    ...
    for epoch in range(1, max_epoch + 1):
        ...
        for data, _ in tqdm(train_loader, desc='train', leave=False):
            ...
            if beta > 0 and r < cutmix_prob:
                ...
                # compute output
                logits_KL,logits_cos,r_wass,r_cos =  model(support, query) # xianzai
                ...
                #    同时起点也是cos:wass = 1：1的关系
                
                
                loss  = loss_cos * torch.exp(r_cos) +loss_KL*torch.exp(r_wass) # 初始值为0,0
                ####
                #=============================================================#
                ...
                # compute output
                logits_KL,logits_cos,r_wass,r_cos =  model(support, query)
